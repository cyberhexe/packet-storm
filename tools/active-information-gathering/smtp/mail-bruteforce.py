...
def is_used_credentials(username, password,
    ...
    if os.path.exists(used_credentials_file):
        with open(used_credentials_file, 'r', errors='replace') as f:
...
if options.user_file:
    ...
    if os.path.exists(user_file_path):
        with open(user_file_path, 'r', errors='replace') as user_file:
...
if options.password_file:
    ...
    if os.path.exists(password_file_path):
        with open(password_file_path, 'r', errors='replace') as password_file:
...
if leak_file_path:
    if os.path.exists(leak_file_path):
        with open(leak_file_path, 'r', errors='replace') as leak_file:
